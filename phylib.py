...
def phylib_roll(newObject, oldObject, time):
    return _phylib.phylib_roll(newObject, oldObject, time)
...
def checkSign(newV, oldV):
    return _phylib.checkSign(newV, oldV)

def phylib_print_object(object):
    return _phylib.phylib_print_object(object)

def phylib_print_table(table):
    return _phylib.phylib_print_table(table)
